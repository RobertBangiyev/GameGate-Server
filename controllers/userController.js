...
exports.user_followings_delete = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
...
exports.user_followers_delete = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
...
exports.user_current_add = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
...
exports.user_current_delete = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
...
exports.user_dropped_add = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
...
exports.user_dropped_delete = function(req, res, next) {
    const newId = req.body.newId ? true : false;
    var params = {
        TableName:"GameGateAccounts",
            Key:{
